...
func Download_test() {
	urls := []string{
		...
		"https://so.gushiwen.org/guwen/default.aspx?p=2",
		"https://so.gushiwen.org/guwen/default.aspx?p=3",
		"https://so.gushiwen.org/guwen/default.aspx?p=4",
		"https://so.gushiwen.org/guwen/default.aspx?p=5",
		"https://so.gushiwen.org/guwen/default.aspx?p=6",
	}
	pool := new(Pool)
